...
class RecordingActivity : AppCompatActivity() {
    ...
    private fun uploadToFirebase() {
        ...
        val progressDialog = ProgressDialog(this).apply {
            setTitle("Please Wait, Uploading...")
    ...
    private fun startStatsMonitor() {
        ...
        fpsTimer = fixedRateTimer("fpsMonitor", true, 0L, 1000L) {
            runOnUiThread {
                ...
                val bitrateEstimate = 8000 * fps / 30
                "FPS: $fps".also { fpsText.text = it }
                "Bitrate: ${bitrateEstimate}kbps".also { bitrateText.text = it }
                "Dropped: $dropped".also { droppedText.text = it }
                frameCount = 0
            }
        }
    }
